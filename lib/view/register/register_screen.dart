      ...
      child: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                          width: Get.width*0.4,
                          child: Text("Preencha os Dados de Acesso e Prossiga")),    ],
                  ),
                  CircleAvatar(
          ...
          CustomInput().textFields(
              ...
              controller: controller.nameEditingController,icon: Icons.person_outlined),
          CustomDecorations().space(2),
          CustomInput().textFields(
          ...
          CustomDecorations().space(2),
          CustomInput().textFields(
              label: "Senha", controller: controller.pwdEditingController,icon: Icons.security),
          CustomDecorations().space(2),
          CustomInput().textFields(
              label: "País - Provincia -Municipio/Bairro",
              controller: controller.locationEditingController,icon: Icons.location_on),
          CustomDecorations().space(2),

          CustomButtons().mainButton(
              label: "Criar Conta",
              onPress: () {
                user.username = controller.nameEditingController.text;
                user.phoneNumber = controller.phoneEditingController.text;
                user.password = controller.pwdEditingController.text;
